    ...
    fetch(request.url, request.options).then(function (response) {
      if (Math.round(response.status / 200) !== 1) {
        response.json().then(function (json) {
          return reject((0, _stringCase.camelize)(json));
