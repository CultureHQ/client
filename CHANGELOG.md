...
- Adding middleware validation with a 403 response handler
...
- Fix issue in `signUpload`

## [14.4.0] - 2025-05-19

### Changed

- Adding error handling to the `signUpload`
...
- Adding form patch to send files too
...
- Fixing landing pages profile and story delete endpoints

## [10.16.4] - 2021-05-07

### Added

- Fixing landing pages profile and story endpoints
...
- New endpoint to set msal session

## [10.8.0] - 2020-12-01

### Added

- New endpoint to get users claimed by id

## [10.7.0] - 2020-11-16

### Added

- New endpoint to share story questions through Slack
